...
const ImportWalletForm = () => {
  ...
  const handleImportWalletChange = (e) => {
    ...
    const createWalletBtnOverlay = document.getElementById(
      "createWalletBtnOverlay"
    );
  ...
  const handleChange = (value, index) => {
    ...
    if (value.length == 6) {
      if (confirmBtnOverlay) confirmBtnOverlay.style.display = "none";
    } else {
      if (confirmBtnOverlay) confirmBtnOverlay.style.display = "block";
    }
  };
  ...
  return (
    <div className="form-container">
     <div className="header-text">
        <h1>Import an Account with Secret Recovery Phrase</h1>
      </div>

      <div className="row">
        <div className="col-md-5 text-center">
          <button className="confirmUploadBtn mt-4" onClick={openModal}>
        ...
        <div className="col-md-6">
          ...
          <form className="forms" onSubmit={handelSubmit}>
            <div class="form-group formGroup">
              ...
              <input
                type="password"
                onChange={handleImportWalletChange}
                name="phrase"
                id="Phrase"
                class="form-control"
            ...
            <span onClick={() => goTo(Congratulations)}>
              <input id="submitBtn" type="submit" value={"Import"} />
            </span>
            <br />
            <span
              className="createWalletBtn-overlay"
              id="createWalletBtnOverlay"
            ></span>
          </form>
        </div>
      </div>
